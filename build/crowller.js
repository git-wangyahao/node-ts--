...
var Crowller = /** @class */ (function () {
    ...
    Crowller.prototype.writeFile = function (content) {
        fs_1.default.writeFileSync(this.filePath, content); //处理写文件
    };
    // 初始化
    Crowller.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRawHtml()]; //初始化html
                    case 1:
                        html = _a.sent() //初始化html
                        ;
...
setInterval(function () {
    var url_s = "https://www.ivsky.com/tupian/meinv_t50/index_" + i + ".html";
